...
import 'package:client/src/components/HR/interview/interview_job_list_page.dart';
import 'package:client/src/components/ProfilePage/profile_page.dart';
import 'package:client/src/constants/app_colors.dart';
import 'package:flutter/material.dart';
import 'package:client/src/constants/app_font_sizes.dart';

class MainNavigationHRPage extends StatefulWidget {
  final int? state;

  const MainNavigationHRPage({super.key, this.state});

  @override
  State<MainNavigationHRPage> createState() => _MainNavigationHRPageState();
}

class _MainNavigationHRPageState extends State<MainNavigationHRPage> {
