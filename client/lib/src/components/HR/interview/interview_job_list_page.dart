...
class InterviewJobListPage extends StatefulWidget {
  const InterviewJobListPage({super.key});

  @override
  State<InterviewJobListPage> createState() => _InterviewJobListPageState();
}

class _InterviewJobListPageState extends State<InterviewJobListPage> {
